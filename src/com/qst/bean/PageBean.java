...
public class PageBean<T> {
    ...
    public PageBean(Integer currentPage, Integer pageSize, Integer beforePage, Integer afterPage, Integer totalRows, Integer totalPages, List<T> list, int Id) {
        this.currentPage = currentPage;
        this.pageSize = pageSize;
